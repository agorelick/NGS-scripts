...
dat = pd.read_csv('/Users/alexgorelick/Dropbox (Partners HealthCare)/MGH CLINICAL/ALEX/germline_data/lpASCN/MDA11/processed_data/MDA11_q=10_Q=20_P=0_1000kbs_data_for_gurobi_long.tsv', delimiter='\t')
threshold = 0.017798 ## 20th percentile of abs(logR(snp) - logR(segment))
