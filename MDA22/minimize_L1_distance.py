...
dat = pd.read_csv('/Users/alexgorelick/Dropbox (Partners HealthCare)/MGH CLINICAL/ALEX/germline_data/lpASCN/MDA22/processed_data/MDA22_q=10_Q=20_P=0_1000kbs_data_for_gurobi_long.tsv', delimiter='\t')
threshold = 0.02691829 ## 20th percentile of abs(logR(snp) - logR(segment))
