...
output_file <- paste0('/home/alg2264/data/alex/lpASCN/C161/C161_q=10_Q=20_P=0_1000kbs_dipLogRsweep_',this_sample,'.tsv')

## define dipLogR values to sweep through
dipLogRs <- seq(-2,2,by=0.5)
l <- sweep_sample(this_sample, sex='female', seg, d, dipLogRs, cores=6)
